...
export default function Project() {
  return (
    ...
    <div className='grid grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1'> 
        ...
        <div className='bg-amber-50 mt-10 shadow-xl ring-0 pb-3 mx-10 rounded-xl p-5 w-96 h-96 hover:scale-105 duration-500 hover:ring-2 hover:ring-black hover:shadow-lg '>
          <div className=' flex flex-col justify-center'>
          <img src={amazon} alt="amazon" className='rounded-md h-64 px-5' />
          <p className='text-2xl font-bold text-center p-2'>AMAZON CLONE</p>
          <div className='grid grid-cols-2'>
            <a href="https://github.com/santhoshpandy/Santhosh-CodeBoosters-Internship/">
            <button className='bg-transparent border ring-2 rounded-full w-32 h-7 ring-black duration-500 shadow-black shadow-xl hover:shadow'>Github</button></a>
            <a href="https://amazon-layout-page.netlify.app">
              <button className='bg-transparent border ring-2 rounded-full w-32 h-7 ring-black duration-500 shadow-xl shadow-black hover:shadow'>Live Demo</button></a>
            </div> 
          </div>
        </div>
        ...
        <div className='bg-amber-50 mt-10 shadow-xl ring-0 pb-3 mx-10 rounded-xl p-5 w-96 h-96 hover:scale-105 duration-500 hover:ring-2 hover:ring-black hover:shadow-lg'>
          <div className=' flex flex-col justify-center'>
          <img src={travelblog} alt="amazon" className='rounded-md hover:scale-105 duration-500 h-64' />
